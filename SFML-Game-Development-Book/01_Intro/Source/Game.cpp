...
Game::Game()
    : mWindow(sf::VideoMode(640, 480), "SFML Application", sf::Style::Close),
      mTexture(), mPlayer(), mFont(), mStatisticsText(),
      mStatisticsUpdateTime(), mStatisticsNumFrames(0), mIsMovingUp(false),
      mIsMovingDown(false), mIsMovingRight(false), mIsMovingLeft(false) {
...
void Game::update(sf::Time elapsedTime) {
  ...
  mPlayer.move(movement * elapsedTime.asSeconds()); //路程=速度*时间
}
